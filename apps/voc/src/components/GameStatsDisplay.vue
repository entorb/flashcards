...
<template>
  ...
  >
    ...
    <!-- Speech bubble tail -->
    <div
      class="absolute top-1/2 -left-2 transform -translate-y-1/2 w-0 h-0 border-t-8 border-t-transparent border-b-8 border-b-transparent border-r-8 border-r-primary/10"
    ></div>
  </div>
</template>
