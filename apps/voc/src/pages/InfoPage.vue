...
<template>
  ...
  <q-page class="q-pa-md">
    ...
    >
      ...
      <div>
        <h3 class="text-subtitle1 text-weight-bold q-mb-sm">
          {{ TEXT_DE.voc.info.modeMultiplierTitle }}
        </h3>
        <p>{{ TEXT_DE.voc.info.modeMultiplierDescription }}</p>
        <ul class="q-pl-md q-mt-sm">
          <li>
            <strong class="text-primary">{{ TEXT_DE.voc.info.modeMultiplierChoice }}</strong>
          </li>
          <li>
            <strong class="text-primary">{{ TEXT_DE.voc.info.modeMultiplierBlind }}</strong>
          </li>
          <li>
            <strong class="text-primary">{{ TEXT_DE.voc.info.modeMultiplierTyping }}</strong>
          </li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="q-pl-md">
          <li class="q-mb-sm">
            {{ TEXT_DE.voc.info.additionalRuleFastCorrect }}
          </li>
          <li class="q-mb-sm">
            {{ TEXT_DE.voc.info.additionalRuleLanguageBonus }}
          </li>
